...
router.post('/add' ,upload.single('image'),async(req, res) => {
  console.log(req.file.path.replace(/\/home\/kawthar\/Desktop\/backend1\/test-backend\/public/,""))
  const title= req.body.title;
  const description =req.body.description;
  const button = req.body.button;
  const image=req.file.path.replace(/\/home\/kawthar\/Desktop\/backend1\/test-backend\/public/,"")
